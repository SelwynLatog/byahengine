...
void driver_model_init(DriverModel& d) {
    ...
    std::cout << "[driver] bounds X:" << (maxX-minX)
    ...
    const glm::mat4& proj)
{
    ...
    // base model matrix — same logic as before, no change to positioning
